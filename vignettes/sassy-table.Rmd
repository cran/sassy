...
Note the following about this example:
  ...
  * The **[reporter](https://reporter.r-sassy.org)** package supports 
  spanning headers and 'N=' population counts in the header labels.
...
```
========================================================================= 
Log Path: C:/Users/User/AppData/Local/Temp/Rtmpum5T6o/log/example2.log 
...
Next: [Example 3: Table](sassy-figure.html)
