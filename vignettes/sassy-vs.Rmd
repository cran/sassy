---
title: "Example 5: VS Table"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Example 5: VS Table}
...
### Create a Table of Vital Signs Statistics
...
Note the following about this example:
  ...
  * The `%eq%` operator from the **[libr](https://libr.r-sassy.org)** package
